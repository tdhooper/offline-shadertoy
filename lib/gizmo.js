...
class Gizmo {
  ...
  _setupThree() {
    ...
    this.controlParentMatrix = new THREE.Matrix4();
  }
  ...
  _save() {
    ...
    mat4.multiply(this.combinedAdjustmentMatrix, this.transforms.before, this.inverseAfter);
    mat4.multiply(this.combinedAdjustmentMatrix, this.combinedAdjustmentMatrix, this.controlObject.matrix.toArray());
  ...
  update(state) {
    ...
    if (this.firstUpdate) {
      ...
      this.controlParentMatrix.fromArray(this.inverseAfter);
      this.controlParentMatrix.decompose(this.controlParent.position, this.controlParent.quaternion, this.controlParent.scale);
