...
class GizmoControl {
  ...
  _onMouseEnter() {
    this.controlObject.material.color.set(0xff0000);
  }

  _onMouseLeave() {
    this.controlObject.material.color.set(0x00ff00);
  }
...
export default class Gizmo {
  ...
  initialise(camera, mouse, renderNodes, uniforms) {
    ...
    this.control.attach(this.gizmoControls[this.activeGizmo].controlObject);
  ...
  _onPointerMove(event) {
    ...
    this.gizmoControls.forEach(gizmoControl => {
      const intersects = this.raycaster.intersectObject(gizmoControl.controlObject).length > 0;
  ...
  _setActiveGizmo(index) {
    this.activeGizmo = index;
    this.control.attach(this.gizmoControls[index].controlObject);
  }
