...
void shadeSurface(inout Hit hit){
    ...
    if (hit.isBackground) {
        ...
        //s = pow(s*20., 4.);
        //hit.color = vec3(mod(angle*6., 1.));
        hit.color = spectrum(angle*5.);
        return;
    }
    ...
    if (hit.model.material.transparency > 0.) {
        ...
        if ( ! hit2.isBackground && hit2.model.material.transparency > 0.) {
            ...
            if ( ! hit3.isBackground && hit3.model.material.transparency > 0.) {
                ...
                // if ( ! hit4.isBackground && hit4.model.material.transparency > 0.) {
                //     Hit hit5 = renderTransparency(hit3, false);
                //     mixTransparency(hit4, hit5);
                // }
